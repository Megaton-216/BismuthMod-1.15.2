...
public class TempChunkGenerator extends NoiseChunkGenerator<TempGenSettings> {
    ...
    public TempChunkGenerator(IWorld worldIn, BiomeProvider provider, TempGenSettings settingsIn) {
